    ...
    <body>
        ...
        <div class="content_wrapper feedback_wrapper" id="feedback">
            ...
            <div class="feedbacks">
                <div class="feedback_container">
                    <img class="feedback_photo" alt="Екатерина" src="images/photo_one.jpg">
                    <h4 class="person_name">Екатерина</h4>
                    <p class="feedback_text">
                        В это волшебное место хочется возвращаться снова и снова
                    </p>
                </div>
                
                <div class="feedback_container">
                    <img class="feedback_photo" alt="Антон" src="images/photo_two.jpg">
                    <h4 class="person_name">Антон</h4>
                    <p class="feedback_text">
                        Я искал тихое место для отдыха, и отель меня не разочаровал
                    </p>
                </div>
                
                <div class="feedback_container last">
                    <img class="feedback_photo" alt="Валерий" src="images/photo_three.jpg">
                    <h4 class="person_name">Валерий</h4>
                    <p class="feedback_text">
                        Я мало что запомнил, но все что запомнил мне понравилось
                    </p>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="feedbacks">
                <div class="feedback_container">
                    <img class="feedback_photo" alt="Анастасия" src="images/photo_four.jpg">
                    <h4 class="person_name">Анастасия</h4>
                    <p class="feedback_text">
                        Лучшее место, чтобы почувствовать единение с природой.
                    </p>
                </div>
                
                <div class="feedback_container">
                    <img class="feedback_photo" alt="Мария" src="images/photo_five.jpg">
                    <h4 class="person_name">Мария</h4>
                    <p class="feedback_text">
                        Отличное место для отдыха с детьми, они не хотели возвращаться домой!
                    </p>
                </div>
                
                <div class="feedback_container last">
                    <img class="feedback_photo" alt="Сергей" src="images/photo_six.jpg">
                    <h4 class="person_name">Сергей</h4>
                    <p class="feedback_text">
                        Обязательно приеду сюда снова! Где можно забронировать номер?
                    </p>
                </div>
                <div class="clear"></div>
            </div>
        ...
        <div class="separation_wrapper" id="subscribe">
            <div class="content_wrapper">
                <h2 class="promo_title">
                    Подпишитесь и получайте <br>новости первым
                </h2>
                <p class="promo_subtitle">
                    В рассылке мы сообщаем о наших акциях и специальных предложениях. <br>Вы можете получать эту информацию из первых рук.
                </p>
                <button class="success_button" id="subscribePopupButton">Подписаться</button>
            </div>
        </div>
        ...
        <div class="popup_wrapper" id="popupWindow">
            <div class="popup">
                ...
                <div id="popupText">
                    <h2 class="popup_title">Подпишитесь на рассылку</h2>
                    <p class="popup_subtitle">
                        Обещаем, что будем присылать вам только самую важную информацию о наших акциях и специальных предложениях.
                    </p>
                    <form id="subscribeForm" action="/php/handler.php" method="post" class="order_form">
                        <input id="emailField" type="text" name="email" placeholder="Введите email" class="popup_input_field">
                        <span id="errorMessage" class="error_message hidden">Пожалуйста, введите ваш email</span>
                        <button class="success_button popup_success_button">Подписаться</button>
                    </form>
                </div>
                <div id="popupSuccess" class="popup_result hidden">
                    <img src="images/check.png" class="popup_result_icon">
                    <h2 class="popup_title">Спасибо за подписку!</h2>
                    <p class="popup_result_subtitle">Теперь вы первыми узнаете о наших акциях и специальных предложениях.</p>
                </div>
                <div id="popupError" class="popup_result hidden">
                    <img src="images/cancel.png" class="popup_result_icon">
                    <h2 class="popup_title">Что-то пошло не так :(</h2>
                    <p class="popup_result_subtitle">Такой email уже зарегистрирован в нашей базе. Попробуйте ввести другой email.</p>
                </div>
            </div>
        </div>
        <!-- End of modal window -->
